...
const createEitherLeftValue = (separator: string): ReaderBox<string, EitherBox<ListBox<number>, string>> =>
    reader((x: string) => left<ListBox<number>, string>(buildList(separator, x)))

const createEitherRightValue = (suffix: string): ReaderBox<string, EitherBox<ListBox<number>, string>> =>
...
tap.test('ReaderMonoid List', async (t) => {
    ...
    t.test('mconcat', async (t) => {
        ...
        const result = listReaderMonoid.mconcat(list as List<ReaderMinBox<string, ListBox<number>>>) as ReaderMinBox<
            string,
            ListBox<number>
        >
    ...
    t.test('Monoid law - right identity: mempty <> x = x', async (t) => {
        ...
        const result1 = listReaderMonoid['<>'](listReaderMonoid.mempty, value1) as ReaderMinBox<string, ListBox<number>>
        const result2 = listReaderMonoid['<>'](listReaderMonoid.mempty, value2) as ReaderMinBox<string, ListBox<number>>
    ...
    t.test('Monoid law - left identity: x <> mempty = x', async (t) => {
        ...
        const result1 = listReaderMonoid['<>'](value1, listReaderMonoid.mempty) as ReaderMinBox<string, ListBox<number>>
        const result2 = listReaderMonoid['<>'](value2, listReaderMonoid.mempty) as ReaderMinBox<string, ListBox<number>>
...
tap.test('ReaderMonoid Maybe', async (t) => {
    ...
    t.test('<>', async (t) => {
        ...
        const result = maybeReaderMonoid['<>'](value1, value2) as ReaderMinBox<string, MaybeBox<ListBox<number>>>
    ...
    t.test('mappend', async (t) => {
        ...
        const result = maybeReaderMonoid.mappend(value1, value2) as ReaderMinBox<string, MaybeBox<ListBox<number>>>
    ...
    t.test('mconcat', async (t) => {
        ...
        const list = cons(value3)(
            cons(value2)(cons(value1)(nil() as List<ReaderBox<string, MaybeBox<ListBox<number>>>>)),
        )
    ...
    t.test('Monoid law - associativity : (x <> y) <> z = x <> (y <> z)', async (t) => {
        ...
        const result1 = maybeReaderMonoid['<>'](
            maybeReaderMonoid['<>'](value1, value2) as ReaderMinBox<string, MaybeBox<ListBox<number>>>,
            value3,
        ) as ReaderMinBox<string, MaybeBox<ListBox<number>>>
        const result2 = maybeReaderMonoid['<>'](
            value1,
            maybeReaderMonoid['<>'](value2, value3) as ReaderMinBox<string, MaybeBox<ListBox<number>>>,
        ) as ReaderMinBox<string, MaybeBox<ListBox<number>>>
    ...
    t.test('Monoid law - right identity: mempty <> x = x', async (t) => {
        ...
        const result1 = maybeReaderMonoid['<>'](maybeReaderMonoid.mempty, value1) as ReaderMinBox<
            string,
            MaybeBox<ListBox<number>>
        >
        const result2 = maybeReaderMonoid['<>'](maybeReaderMonoid.mempty, value2) as ReaderMinBox<
            string,
            MaybeBox<ListBox<number>>
        >
    ...
    t.test('Monoid law - left identity: x <> mempty = x', async (t) => {
        ...
        const result1 = maybeReaderMonoid['<>'](value1, maybeReaderMonoid.mempty) as ReaderMinBox<
            string,
            MaybeBox<ListBox<number>>
        >
        const result2 = maybeReaderMonoid['<>'](value2, maybeReaderMonoid.mempty) as ReaderMinBox<
            string,
            MaybeBox<ListBox<number>>
        >
...
tap.test('ReaderMonoid Either', async (t) => {
    ...
    t.test('mempty', async (t) => {
        const result = eitherReaderMonoid.mempty as ReaderMinBox<string, EitherBox<ListBox<number>, string>>
    ...
    t.test('<>', async (t) => {
        ...
        const result = eitherReaderMonoid['<>'](value1, value2) as ReaderMinBox<
            string,
    ...
    t.test('mappend', async (t) => {
        ...
        const result = eitherReaderMonoid.mappend(value1, value2) as ReaderMinBox<
            string,
            EitherBox<ListBox<number>, string>
        >
    ...
    t.test('mconcat', async (t) => {
        ...
        const list = cons(value3)(
            cons(value2)(cons(value1)(nil() as List<ReaderBox<string, EitherBox<ListBox<number>, string>>>)),
        )
    ...
    t.test('Monoid law - associativity : (x <> y) <> z = x <> (y <> z)', async (t) => {
        ...
        const result1 = eitherReaderMonoid['<>'](
            eitherReaderMonoid['<>'](value1, value2) as ReaderMinBox<string, EitherBox<ListBox<number>, string>>,
            value3,
        ) as ReaderMinBox<string, EitherBox<ListBox<number>, string>>
        const result2 = eitherReaderMonoid['<>'](
            value1,
            eitherReaderMonoid['<>'](value2, value3) as ReaderMinBox<string, EitherBox<ListBox<number>, string>>,
        ) as ReaderMinBox<string, EitherBox<ListBox<number>, string>>
    ...
    t.test('Monoid law - right identity: mempty <> x = x', async (t) => {
        ...
        const result1 = eitherReaderMonoid['<>'](eitherReaderMonoid.mempty, valueL) as ReaderMinBox<
            string,
            EitherBox<ListBox<number>, string>
        >
        const result2 = eitherReaderMonoid['<>'](eitherReaderMonoid.mempty, valueR) as ReaderMinBox<
            string,
            EitherBox<ListBox<number>, string>
        >

        t.same(toVal(result1.runReader('12') as EitherBox<ListBox<number>, string>), toVal(valueL.runReader('12')))
        t.same(toVal(result2.runReader('ab') as EitherBox<ListBox<number>, string>), toVal(valueR.runReader('ab')))
    })
    ...
    t.test('Monoid law - left identity: x <> mempty = x', async (t) => {
        ...
        const result1 = eitherReaderMonoid['<>'](valueL, eitherReaderMonoid.mempty) as ReaderMinBox<
            string,
            EitherBox<ListBox<number>, string>
        >
        const result2 = eitherReaderMonoid['<>'](valueR, eitherReaderMonoid.mempty) as ReaderMinBox<
            string,
            EitherBox<ListBox<number>, string>
        >
...
tap.test('ReaderMonoid Tuple', async (t) => {
    const toArrs = (x: TupleMinBox<ListBox<number>, ListBox<number>>): [number[], number[]] => [
        toArray(fst(x) as ListBox<number>),
        toArray(snd(x) as ListBox<number>),
    ]

    t.test('mempty', async (t) => {
        const result = tupleReaderMonoid.mempty as ReaderMinBox<string, TupleMinBox<ListBox<number>, ListBox<number>>>
        t.same(toArrs(result.runReader('123') as TupleMinBox<ListBox<number>, ListBox<number>>), [[], []])
    })
    ...
    t.test('<>', async (t) => {
        ...
        const result = tupleReaderMonoid['<>'](value1, value2) as ReaderMinBox<
            string,
            TupleMinBox<ListBox<number>, ListBox<number>>
        >

        t.same(toArrs(result.runReader('34') as TupleMinBox<ListBox<number>, ListBox<number>>), [
            [3, 1, 4, 3, 3, 4],
            [3, 2, 4, 3, 4, 4],
        ])
    })
    ...
    t.test('mappend', async (t) => {
        ...
        const result = tupleReaderMonoid.mappend(value1, value2) as ReaderMinBox<
            string,
            TupleMinBox<ListBox<number>, ListBox<number>>
        >

        t.same(toArrs(result.runReader('56') as TupleMinBox<ListBox<number>, ListBox<number>>), [
            [5, 3, 6, 5, 5, 6],
            [5, 4, 6, 5, 6, 6],
        ])
    })
    ...
    t.test('mconcat', async (t) => {
        ...
        const list = cons(value3)(
            cons(value2)(cons(value1)(nil() as List<ReaderBox<string, TupleMinBox<ListBox<number>, ListBox<number>>>>)),
        )
        const result = tupleReaderMonoid.mconcat(
            list as List<ReaderMinBox<string, TupleMinBox<ListBox<number>, ListBox<number>>>>,
        ) as ReaderMinBox<string, TupleMinBox<ListBox<number>, ListBox<number>>>

        t.same(toArrs(result.runReader('78') as TupleMinBox<ListBox<number>, ListBox<number>>), [
            [7, 5, 8, 7, 3, 8, 7, 1, 8],
            [7, 6, 8, 7, 4, 8, 7, 2, 8],
        ])
    })
    ...
    t.test('Monoid law - associativity : (x <> y) <> z = x <> (y <> z)', async (t) => {
        ...
        t.same(toArrs(result1.runReader('78') as TupleMinBox<ListBox<number>, ListBox<number>>), expected)
        t.same(toArrs(result2.runReader('78') as TupleMinBox<ListBox<number>, ListBox<number>>), expected)
    })
    ...
    t.test('Monoid law - right identity: mempty <> x = x', async (t) => {
        ...
        const result1 = tupleReaderMonoid['<>'](tupleReaderMonoid.mempty, value1) as ReaderMinBox<
            string,
            TupleMinBox<ListBox<number>, ListBox<number>>
        >
        const result2 = tupleReaderMonoid['<>'](tupleReaderMonoid.mempty, value2) as ReaderMinBox<
            string,
            TupleMinBox<ListBox<number>, ListBox<number>>
        >
    ...
    t.test('Monoid law - left identity: x <> mempty = x', async (t) => {
        ...
        const result1 = tupleReaderMonoid['<>'](value1, tupleReaderMonoid.mempty) as ReaderMinBox<
            string,
            TupleMinBox<ListBox<number>, ListBox<number>>
        >
        const result2 = tupleReaderMonoid['<>'](value2, tupleReaderMonoid.mempty) as ReaderMinBox<
            string,
            TupleMinBox<ListBox<number>, ListBox<number>>
        >
...
tap.test('ReaderMonoid Promise', async (t) => {
    const toArr = async (p: PromiseBox<ListBox<number>>) => toArray(await p)
    ...
    t.test('<>', async (t) => {
        ...
        t.same(await toArr(result.runReader('34') as PromiseBox<ListBox<number>>), [3, 1, 4, 3, 2, 4])
    })
    ...
    t.test('mappend', async (t) => {
        ...
        const result = promiseReaderMonoid.mappend(value1, value2) as ReaderMinBox<string, PromiseBox<ListBox<number>>>

        t.same(await toArr(result.runReader('56') as PromiseBox<ListBox<number>>), [5, 3, 6, 5, 4, 6])
    })
    ...
    t.test('mconcat', async (t) => {
        ...
        const list = cons(value3)(
            cons(value2)(cons(value1)(nil() as List<ReaderBox<string, PromiseBox<ListBox<number>>>>)),
        )
        ...
        t.same(await toArr(result.runReader('78') as PromiseBox<ListBox<number>>), [7, 3, 8, 7, 2, 8, 7, 1, 8])
    })
    ...
    t.test('Monoid law - associativity : (x <> y) <> z = x <> (y <> z)', async (t) => {
        ...
        const result1 = promiseReaderMonoid['<>'](
            promiseReaderMonoid['<>'](value1, value2) as ReaderMinBox<string, PromiseBox<ListBox<number>>>,
            value3,
        ) as ReaderMinBox<string, PromiseBox<ListBox<number>>>
        const result2 = promiseReaderMonoid['<>'](
            value1,
            promiseReaderMonoid['<>'](value2, value3) as ReaderMinBox<string, PromiseBox<ListBox<number>>>,
        ) as ReaderMinBox<string, PromiseBox<ListBox<number>>>

        const expected = [7, 1, 8, 7, 2, 8, 7, 3, 8]

        t.same(await toArr(result1.runReader('78') as PromiseBox<ListBox<number>>), expected)
        t.same(await toArr(result2.runReader('78') as PromiseBox<ListBox<number>>), expected)
    })
    ...
    t.test('Monoid law - right identity: mempty <> x = x', async (t) => {
        ...
        const result1 = promiseReaderMonoid['<>'](promiseReaderMonoid.mempty, value1) as ReaderMinBox<
            string,
            PromiseBox<ListBox<number>>
        >
        const result2 = promiseReaderMonoid['<>'](promiseReaderMonoid.mempty, value2) as ReaderMinBox<
            string,
            PromiseBox<ListBox<number>>
        >
    ...
    t.test('Monoid law - left identity: x <> mempty = x', async (t) => {
        ...
        const result1 = promiseReaderMonoid['<>'](value1, promiseReaderMonoid.mempty) as ReaderMinBox<
            string,
            PromiseBox<ListBox<number>>
        >
        const result2 = promiseReaderMonoid['<>'](value2, promiseReaderMonoid.mempty) as ReaderMinBox<
            string,
            PromiseBox<ListBox<number>>
        >
