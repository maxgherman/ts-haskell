...
import { semigroup as createSemigroup } from "ghc/base/tuple/tuple2-semigroup.ts";
import {
  semigroup as createListSemigroup,
} from "ghc/base/list/list-semigroup.ts";
import { semigroup as createMaybeSemigroup } from "ghc/base/maybe/maybe-semigroup.ts";
import { $case as maybeCase, just, MaybeBox } from "ghc/base/maybe/maybe.ts";
import { cons, ListBox, nil, toArray } from "ghc/base/list/list.ts";
import { fst, snd, tuple2 } from "ghc/base/tuple/tuple.ts";
