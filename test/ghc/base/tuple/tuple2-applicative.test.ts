...
tap.test('Tuple2 applicative', async (t) => {
    ...
    t.test('<*>', async (t) => {
        ...
        const f = tuple2(
            Promise.resolve(compose(cons<string>('1'), cons<string>('2'), cons('3'))(nil())) as PromiseBox<
                ListBox<string>
            >,
            app,
        )
        const fa = tuple2(
            Promise.resolve(compose(cons<string>('4'), cons<string>('5'), cons('6'))(nil())) as PromiseBox<
                ListBox<string>
            >,
            11,
        )
    ...
    t.test('<**>', async (t) => {
        const fa = tuple2(
            Promise.resolve(compose(cons<string>('1'), cons('2'))(nil())) as PromiseBox<ListBox<string>>,
            11,
        )
    ...
    t.test('Applicative forth law (Composition): pure (.) <*> u <*> v <*> w = u <*> (v <*> w)', async (t) => {
        ...
        const u = tuple2(
            Promise.resolve(compose(cons<string>('3'), cons('4'))(nil())) as PromiseBox<ListBox<string>>,
            app3,
        )
        const w = tuple2(
            Promise.resolve(compose(cons<string>('5'), cons('6'))(nil())) as PromiseBox<ListBox<string>>,
            7,
        )
