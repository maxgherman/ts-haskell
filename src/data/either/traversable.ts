...
import { functor, EitherFunctor } from './functor'
import { foldable, EitherFoldable } from './foldable'
import { $case, left, right, EitherBox } from './either'
import { MinBox1 } from 'data/kind'

export interface EitherTraversable<E> extends Traversable, EitherFunctor<E>, EitherFoldable<E> {
