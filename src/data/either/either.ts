...
export const left = <TL, TR = unknown>(
  value: NonNullable<TL>,
): EitherBox<TL, TR> => createResult<TL>(value, "Left");

export const right = <TL, TR>(value: NonNullable<TR>): EitherBox<TL, TR> =>
  createResult<TR>(value, "Right");
