...
export interface IBoxedArrayApplicative extends IApplicative<IsBoxedArray> {
    ...
    liftA2<A, B, C, X extends Application2<A, B, C>>(
        abc: X, fa: BoxedArrayBox<A>,
        fb: BoxedArrayBox<B>): BoxedArrayBox<C>
    liftA3<A, B, C, D>(
        f: Application3<A, B, C, D>,
        fa: BoxedArrayBox<A>,
        fb: BoxedArrayBox<B>,
        fc: BoxedArrayBox<C>): BoxedArrayBox<D>
...
const lift = <A, B>(
    fab: BoxedArrayBox<Application<A, B>>, fa: BoxedArrayBox<A>): BoxedArrayBox<B> => {
