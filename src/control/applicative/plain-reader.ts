...
export interface IReaderApplicative<T> extends IApplicative<IsPlainReader> {
    ...
    lift<A, B>(
        fab: PlainReaderBox<T, Application<A, B>>, fa: PlainReaderBox<T, A>): PlainReaderBox<T, B>
    '<*>'<A, B>(
    ...
    '<**>'<A, B>(
        fa: PlainReaderBox<T, A>, fab: PlainReaderBox<T, Application<A, B>>): PlainReaderBox<T, B>
}
...
const lift =
    <R, A, B>(
        fab: PlainReaderBox<R, Application<A, B>>,
        fa: PlainReaderBox<R, A>): PlainReaderBox<R, B> => {
