...
export interface IReaderMonad<T> extends IMonad<IsReader> {
    ...
    liftA2<A, B, C, X extends Application2<A, B, C>>(abc: X, fa: ReaderBox<T,A>, fb: ReaderBox<T,B>): ReaderBox<T,C>;
    liftA3<A, B, C, D>(f: Application3<A, B, C, D>, fa: ReaderBox<T,A>, fb: ReaderBox<T,B>, fc: ReaderBox<T,C>): ReaderBox<T,D>; 
