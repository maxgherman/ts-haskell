...
export interface FunctionArrowSemigroup<A, B extends Semigroup<B>> extends Semigroup<FunctionArrowMinBox<A, B>> {
...
export const semigroup = <A, B extends Semigroup<B>>(innerSemigroup: Semigroup<B>) =>
    createSemigroup(base<A, B>(innerSemigroup)) as FunctionArrowSemigroup<A, Semigroup<B>>
